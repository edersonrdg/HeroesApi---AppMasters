...
exports.formatHeroToReturn = exports.formatHeroDataToSortOrSearch = void 0;
const formatHeroDataToSortOrSearch = (heroData) => {
...
exports.formatHeroDataToSortOrSearch = formatHeroDataToSortOrSearch;
const formatHeroToReturn = (arr) => {
    return arr.map(hero => {
        return {
            id: hero.id,
            name: hero.name,
...
exports.formatHeroToReturn = formatHeroToReturn;
